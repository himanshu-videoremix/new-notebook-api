                                ...
                                <span>
                                  {voice.name} ({voice.gender === 'f' ? 'Female' : 'Male'})
                                    ...
                                    className={`ml-2 transition-colors ${
                                      audioPreviewUtils.isPlaying() ? 'text-primary' : ''
                                    }`}
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      try {
                    ...
                    <div className="space-y-4 pl-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(transitions) => setAudioSettings(prev => ({
                            ...prev,
                            soundEffects: { ...prev.soundEffects, transitions }
                          }))}
                        />
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(ambience) => setAudioSettings(prev => ({
                            ...prev,
                            soundEffects: { ...prev.soundEffects, ambience }
                          }))}
                        />
                      </div>
                    </div>
